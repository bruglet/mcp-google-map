...
const SCHEMA = {
  ...
  dwell_minutes: z
    ...
    .optional()
    .describe("Minutes spent at each stop, aligned with stops before reordering; omitted entries are zero."),
  detail_level: z
