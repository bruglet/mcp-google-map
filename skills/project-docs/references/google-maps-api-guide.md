# Historical upstream Google Maps API guide

> Retained for upstream comparison only. The current fork’s authoritative
> request, credential, and cost policy is in `docs/ARCHITECTURE.md`,
> `docs/COST_POLICY.md`, and `skills/google-maps/references/tools-api.md`.
> Never copy client-supplied credential behavior from this historical guide.
